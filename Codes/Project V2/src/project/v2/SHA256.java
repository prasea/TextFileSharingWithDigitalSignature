...
import static project.v2.SHA256.readFile;
...
public class SHA256 {
    ...
    private static final int BLOCK_BYTES = BLOCK_BITS / 8; //64
    ...
    public static byte[] readFile(String file) throws IOException {
     ...
     public static void main(String[] args) throws IOException 
     {
        ...
        byte[] b = readFile("C:\\Users\\Prajanya\\Documents\\Hello.txt");
        byte[] hasb = hash(b);
        String haString = DatatypeConverter.printHexBinary( hasb);
         System.out.println(haString);
    }
    /**
